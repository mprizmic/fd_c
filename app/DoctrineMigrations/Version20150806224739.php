 ...
 */
class Version20150806224739 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE frase (id INT AUTO_INCREMENT NOT NULL, frase VARCHAR(250) NOT NULL, fecha DATE NOT NULL, autor VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
