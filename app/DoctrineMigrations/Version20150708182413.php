 ...
 */
class Version20150708182413 extends AbstractMigration
{
...
//        $this->addSql("DROP TABLE media_orientaciones");
        $this->addSql("ALTER TABLE estado_carrera ADD comentario VARCHAR(250) DEFAULT NULL");
    }
...
//        $this->addSql("DROP TABLE turno_unidad_educativa");
        $this->addSql("ALTER TABLE estado_carrera DROP comentario");
    }
}
