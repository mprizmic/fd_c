 ...
 */
class Version20150528180307 extends AbstractMigration
{
...
//        $this->addSql("ALTER TABLE turno_unidad_educativa ADD CONSTRAINT FK_167633EA69C5211E FOREIGN KEY (turno_id) REFERENCES turno (id)");
        $this->addSql("ALTER TABLE establecimiento CHANGE fecha_creacion fecha_creacion VARCHAR(10) DEFAULT NULL");
    }
...
//        $this->addSql("DROP TABLE turno_unidad_educativa");
        $this->addSql("ALTER TABLE establecimiento CHANGE fecha_creacion fecha_creacion DATETIME DEFAULT NULL");
    }
}
