 ...
 */
class Version20150713162423 extends AbstractMigration
{
...
//        $this->addSql("CREATE TABLE turno_unidad_educativa (id INT AUTO_INCREMENT NOT NULL, unidad_educativa_id INT DEFAULT NULL, turno_id INT DEFAULT NULL, INDEX IDX_167633EABF20CF2F (unidad_educativa_id), INDEX IDX_167633EA69C5211E (turno_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE secundariox_orientacion (secundariox_id INT NOT NULL, orientacion_id INT NOT NULL, INDEX IDX_98FC28242ED5694E (secundariox_id), INDEX IDX_98FC2824F73C956F (orientacion_id), PRIMARY KEY(secundariox_id, orientacion_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
