 ...
 */
class Version20151029161312 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE ee_dependencia (id INT AUTO_INCREMENT NOT NULL, dependencia_id INT DEFAULT NULL, establecimiento_id INT DEFAULT NULL, te VARCHAR(50) DEFAULT NULL, email VARCHAR(50) DEFAULT NULL, actualizado DATETIME NOT NULL, creado DATETIME NOT NULL, INDEX IDX_3D418597DF2432B6 (dependencia_id), INDEX IDX_3D41859771B61351 (establecimiento_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
