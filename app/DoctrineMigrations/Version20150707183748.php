 ...
 */
class Version20150707183748 extends AbstractMigration
{
...
//        $this->addSql("DROP TABLE media_orientaciones");
        $this->addSql("ALTER TABLE localizacion ADD matricula INT DEFAULT NULL");
    }
...
//        $this->addSql("DROP TABLE turno_unidad_educativa");
        $this->addSql("ALTER TABLE localizacion DROP matricula");
    }
}
