...
class PrimarioUnidadOfertaHandler extends UnidadOfertaHandler {

    const TIPO_UNIDAD_OFERTA = "Primario";
    /**
    ...
    public function eliminarAll(Localizacion $localizacion, $flush = true) {
        ...
        try {
            ...
            $respuesta->setMensaje('Se eliminó la primaria para el edificio seleccionado.');
        } catch (Exception $ex) {
            $respuesta->setCodigo(2);
            $respuesta->setMensaje('No se pudieron eliminar el primario. Verifíquelo y reintente.');
        };
        return $respuesta;
    }
